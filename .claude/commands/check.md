...
4. Frontend değiştiyse: `cd apps/frontend-web && npx tsc -b`.
   **`--noEmit` KULLANMA:** kök tsconfig solution-style (`files: []`); `--noEmit`
   hiçbir dosyayı kontrol etmez ve her zaman 0 döner — yani kontrol ettiğini
   sanarsın. Bkz. CLAUDE.md > Geliştirme.

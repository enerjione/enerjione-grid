<!-- VENDOR EDILMIS BELGE — KAYNAK: enerjione-grid-dnp3-gateway
     ...
     DURUM: PR HENUZ ACIK. Gateway 1.15.0 yayinlanmadi; bu sozlesme
     degisebilir. Grid tarafinda wire<->model esleme TEK bir adaptor
     katmaninda tutulur, boylece son sozlesme farkli cikarsa degisiklik
     tek noktada kalir.

     Bu dosya ELLE DUZENLENMEZ. Gateway 1.15.0 yayinlandiginda release
     artifact'i ile degistirilir (bkz. infra/gateway-contract provenance
     mekanizmasi). -->

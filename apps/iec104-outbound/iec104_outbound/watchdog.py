...
BU SERVISTE IKI SEY BIRDEN ARANIR (bkz. main.py `_kalp_dongusu`):
  * asyncio olay dongusu donuyor mu — IEC 104 sunuculari ve katalog
    esitleyicisi orada yasiyor; dongu bloklanirsa SCADA'ya tek ASDU gitmez.
  * tuketici IPLIGI ayakta mi — telemetri o iplikten geliyor. Iplik olduyse
    olay dongusu neseyle donmeye devam eder ve disaridan her sey normal
    gorunur; yayin ise tamamen durmustur.
Ikisi de TRAFIKTEN BAGIMSIZ olcumlerdir: sessiz bir gecede ikisi de saglikli
kalir, yani yanlis yere restart uretmezler.
